        ...
        <AnonymousTemplate >
            ...
            <asp:CreateUserWizard ID="CreateUserWizard1" runat="server" BackColor="#F7F6F3" BorderColor="#E6E2D8" BorderStyle="Solid" BorderWidth="1px" Font-Names="Verdana" Font-Size="0.8em" 
                ...
                <WizardSteps>
                    ...
                    <asp:WizardStep runat="server" ID="ProfileDataStepWizard" AllowReturn="False" Title="Complete Profile">
            ...
            <asp:RoleGroup Roles="Admin">
                <ContentTemplate>
                    <div class="default-container">
                        ...
                        <asp:LinkButton ID="BtnUsers" runat="server" OnClick="BtnUsers_Click">Administrate Users</asp:LinkButton> |
                        <asp:LinkButton ID="BtnGroups" runat="server" OnClick="BtnGroups_Click">Administrate Groups</asp:LinkButton>
                    </div>
                </ContentTemplate>
            </asp:RoleGroup>
        </RoleGroups>
